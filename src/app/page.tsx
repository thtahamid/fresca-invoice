    ...
    <div className="min-h-screen bg-background p-4 md:p-8 lg:p-12 transition-colors duration-500">
      ...
      <div className="max-w-7xl mx-auto mb-12">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12">
          <div>
            <h1 className="text-responsive-h1 tracking-tighter text-primary">
          ...
          <div className="flex items-center gap-2 md:gap-4 bg-card p-1.5 md:p-2 rounded-2xl md:rounded-3xl shadow-pop">
            <StepIndicator
            ...
            />
            <div className="w-4 md:w-8 h-1 bg-muted rounded-full" />
            <StepIndicator
              active={step === "review"}
          ...
          {step === "selection" && (
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
                <h2 className="text-responsive-h2 text-foreground">
                  Product Catalog
                </h2>
                <Button
                  disabled={items.length === 0}
                  onClick={() => setStep("review")}
                  className="w-full sm:w-auto rounded-2xl h-14 px-8 bg-sky text-sky-foreground hover:bg-sky/90 font-black shadow-pop hover:scale-105 transition-all text-lg"
                >
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                  <Button
                    variant="ghost"
                    onClick={() => setStep("selection")}
                    className="w-full sm:w-auto rounded-2xl h-14 px-8 font-black text-lg"
                  >
                    <ArrowLeft className="mr-2 w-6 h-6" /> Back
                  </Button>
                  <Button
                    onClick={() => setStep("preview")}
                    className="w-full sm:w-auto rounded-2xl h-14 px-8 bg-lavender text-lavender-foreground hover:bg-lavender/90 font-black shadow-pop hover:scale-105 transition-all text-lg"
                  >
            ...
            <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 print:hidden">
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                  ...
                  <Button
                    onClick={handlePrint}
                    className="w-full sm:w-auto rounded-2xl h-14 px-8 bg-primary text-primary-foreground hover:bg-primary/90 font-black shadow-pop hover:scale-105 transition-all text-lg"
                  >
              ...
              <div
                ...
                className="flex justify-center bg-muted/20 p-8 md:p-12 rounded-[3rem] shadow-inner"
              >
...
function StepIndicator({
  ...
  return (
    <button
      onClick={onClick}
      className={cn(
        "flex items-center gap-2 md:gap-3 px-3 md:px-6 py-2 md:py-3 rounded-xl md:rounded-2xl font-black transition-all",
        active
    ...
    >
      ...
      >
        {completed ? <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5" /> : null}
